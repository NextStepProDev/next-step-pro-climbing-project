    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] px-4">
        <div className="bg-surface-900 rounded-xl p-8 max-w-md w-full border border-surface-800 text-center">
          <h2 className="text-xl font-bold text-surface-100 mb-2">{t('resetPassword.invalidLink')}</h2>
          <p className="text-surface-400 mb-6">{t('resetPassword.noToken')}</p>
    ...
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-4">
      <div className="bg-surface-900 rounded-xl p-8 max-w-md w-full border border-surface-800">
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl font-bold text-surface-100">{t('resetPassword.title')}</h1>
        </div>
